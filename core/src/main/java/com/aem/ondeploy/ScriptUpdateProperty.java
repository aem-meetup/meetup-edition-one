...
/**
 * Used when a new property is added to a particular Component
 * This Script adds new property to content of specific resourceType
 */
    ...
    protected void execute() throws Exception {
        ...
        try {
            for (Hit hit : hits) {
                ...
                valueMap.put("imageTitle","Hero Image");
            }
        }
